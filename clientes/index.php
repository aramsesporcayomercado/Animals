...
<link type="image/png" sizes="64x64" rel="icon" href="img/instructor.png">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
<link type="image/png" sizes="32x32" rel="icon" href="img/icons8-men-64.png">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="index.html" class="active"><i class="fa fa-home nav_icon"></i>Panel Del Cliente</a>
							<a href="rutinas/data2_table.php"><i class="fa fa-table nav_icon"></i>Rutinas</span></a>
						</li>
						<!--<li>
							<a href="rutinas/rutina/data2_table.php"><i class="fa fa-table nav_icon"></i>Rutinas</span></a>
						</li>-->
					</ul>
					<!-- //sidebar-collapse -->
				</nav>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									...
									<div class="user-name">
										<p></p> <!-- poner el nombre de el administrador-->
										<span>Cliente</span>
									</div>
