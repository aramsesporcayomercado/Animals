  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Crear Instructor</h5>
        ...
        <form method="POST" id="formulario" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <label for="entrada">Ingrese La Entrada</label>
                    <input type="date" name="entrada" id="entrada" class="form-control">
                    <br />

                    <label for="salida">Ingrese la Salida</label>
        ...
        if ($estado == "1"){ ?>
	        <option value="<?php echo $row[9] ?>">ACTIVO</option>
<?php }else{ ?>
            <option value="<?php echo $row[9] ?>">INACTIVO</option>
<?php  }    ?>
