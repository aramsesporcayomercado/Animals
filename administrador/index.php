...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['usuario']) || empty($_POST['contraseña'])) {
            ...
            $query = mysqli_query($conexion, "SELECT * FROM login WHERE usuario = '$user' AND contraseña = '$contraseña'");
...
<link type="image/png" sizes="32x32" rel="icon" href="img/icon-administrator-male.png">
...
<body class="cbp-spmenu-push">
	<div class="main-content">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="index.html" class="active"><i class="fa fa-home nav_icon"></i>Panel De Administracion</a>
						</li>
						<!--<li>
						...
						<li>
							<a href="instructores/index.php"><i class="fa fa-table nav_icon"></i>Instructores</span></a>
						</li>
						<li>
							<a href="clientes/index.php"><i class="fa fa-table nav_icon"></i>Clientes</a>
						</li>
						<li>
							<a href="../carrito/admin/productos.php"><i class="fa fa-table nav_icon"></i>Productos </a>
						</li>
						<li>
							<a href="anuncios/data2_table.php"><i class="fa fa-table nav_icon"></i>Anuncios</a>
						</li>
						<li>
							<a href="inventario/index.php"><i class="fa fa-table nav_icon"></i>Inventario</a>
						</li>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									...
									<div class="user-name">
										<p><?php echo $_SESSION['usuario']; ?></p> <!-- poner el nombre de el administrador-->
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="cerrar_session.php"><i class="fa fa-sign-out"></i> Logout</a> </li>
							</ul>
						</li>
					</ul>
				</div>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="row-one">
					<div class="col-md-4 widget">
						...
						<div class="stats-right">
							...
							<!--?php
                        $query = mysqli_query($conexion, "SELECT(count id) FROM productos");
				...
				<!--termina la parte de arriba-->
				<!-- empieza la parte de abajo-->
				<?php

				require("./grafica/db/conexion.php");
				// cambiar la consultas //
						$busca2 = $mysqli->query("SELECT COUNT(id) FROM clientes");
		...
		<footer class="py-5 bg-dark">
			<div class="row">
				<div class="col-md-5">
						...
						<div class="col-md-7">
							<h2>Conectate con nuestro gimnasio</h2>
							<br>
								<p class="title-p"></p>
                                <div class="info">
                                    <span class="fa fa-map-marker" >Quetzal Morelos, Zona Urbana 39530 Acapulco de Juárez, Gro. </span> <p></p>
                                    <span class="fa fa-phone">+52 7341047536</span><p></p>
                                    <span class="fa fa-envelope">arathbusinessman1724@gmail.com</span>
                                </div>
						</div>
			</div>
	    </footer>
  ...
  const etiquetas = ["Clientes Registrados", "Productos"]
