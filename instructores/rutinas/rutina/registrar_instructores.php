...
<body>
    ...
    <div class="container">
		<form name="FORM1" method="POST" action="alta_instructor.php">
			...
			descripcion:<input type="text" name="descripcion" placeholder="Ingresa tu descripcion porfavor"><p></p>
			consejos:<input type="text" name="consejos" placeholder="Ingresa los consejos porfavor"><p></p>
